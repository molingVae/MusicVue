<template lang="html">
  <div class="play">
    <div class="header">
      <div class="title">
        <router-link to="/">
          <i class="iconfont icon-shouye left" style="color: red"></i>
        </router-link>
    ...
    <div class="song-info">
      ...
      <div class="iconbox">
        ...
        <i class="box"></i>
         <a :href="currentUrl.bitrate.show_link" ><i class="iconfont icon-xiazai right"></i></a>
      </div>
    </div>
    <div class="song">
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      xaizai(){
        console.log(this.currentUrl.bitrate.show_link)
      }
    }
